...
public class ModReceipeProvider extends RecipeProvider {
    public ModReceipeProvider(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pRegistries) {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.ALEXANDRITE.get(), 32)
                ...
                .save(pRecipeOutput, FirstMod.MOD_ID + ":alexandrite_from_magic_block");
